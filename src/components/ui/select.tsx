  ...
  field: {
    ...
    select: {
      ...
      colors: {
        ...
        dark: "bg-gray-50 border-gray-300 text-gray-500 dark:text-gray-50 placeholder-gray-400 focus:border-gray-500 focus:ring-gray-500 dark:border-gray-300 dark:bg-black dark:focus:border-gray-500 dark:focus:ring-gray-800 py-4",
      },
    },
  },
};
    ...
    <div>
      <div className="mb-3 block">
        <Label
          htmlFor={label}
          value={label}
          className="dark:text-gray-200 uppercase"
        />
      </div>

      <Select theme={customSelectTheme} color={"dark"} id="countries" required className={styles}>
